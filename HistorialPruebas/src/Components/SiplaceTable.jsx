    ...
    if (componentsdata.length > 0) {
      ...
      try {
        ...
        const response = await axios.get(
          `${server}/api/siplacecomponents?serialnumber=${pcb}&smtLine=${line}`
        );
        if (
    ...
    <div className="table-responsive CTitulos ">
      {loading === true ? (
        ...
        <div className="a">
          ...
          <h3>
            No se encontraron componentes consumidos por {props.PCB} en SMT.
          </h3>
        </div>
      ) : (
        <div>
                    ...
                    <a
                      ...
                      onClick={(e) =>
                        handleLinkClick(
                          e,
                          "UID",
                          components.packagingUniqueId,
                          components.rawComponentBarcode
                        )
                      }
                    >
                      {components.packagingUniqueId}
