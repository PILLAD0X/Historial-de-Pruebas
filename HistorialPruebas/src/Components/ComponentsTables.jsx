...
const ComponentsTable = ({props}) => {
  ...
  const exportToExcel = () => {
    const ws = Array.isArray(topSmtComponents) ? XLSX.utils.json_to_sheet(topSmtComponents) : null;
    const ws2 = Array.isArray(bottonSmtComponents) ? XLSX.utils.json_to_sheet(bottonSmtComponents) : null;
    const ws3 = Array.isArray(topThtComponents) ? XLSX.utils.json_to_sheet(topThtComponents) : null;
    ...
    if (bottonSmtComponents.length > 0) {
      XLSX.writeFile(
        wb,
        `Components Consumed by ${props.PCB}.xlsx`
    ...
    return (
        <>
            ...
            {topSmtComponents === '' || topThtComponents === '' || bottonSmtComponents === '' ?
                <p></p>
            :
                <div className="table-responsive CTitulos ">
                    <div className="">
